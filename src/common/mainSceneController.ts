...
export class MainSceneController extends SceneController {
	...
	createScene(_game: g.Game): g.Scene {
		...
		asaEx.ResourceManager.addAsaAssetIds(spriteUtil.getPjNamesFromAsainfoMap(CommonAsaInfo), assetIds);
		asaEx.ResourceManager.addAsaAssetIds(spriteUtil.getPjNamesFromAsainfoMap(AsaInfo), assetIds);
